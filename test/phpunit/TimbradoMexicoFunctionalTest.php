...
/**
 * \file    test/phpunit/TimbradoMexicoFunctionalTest.php
...
/**
 * Class TimbradoMexicoFunctionalTest
 *
 ...
 *
 * @package Testtimbradomexico
 */
class TimbradoMexicoFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modTimbradoMexico')->click();
		} else {
			// Disable the module
			$this->byHref('modTimbradoMexico')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/timbradomexico/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('timbradomexico/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/timbradomexico/admin/about.php');
		$this->authenticate();
		return $this->assertContains('timbradomexico/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('timbradomexicowidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modTimbradoMexico_TimbradoMexicoTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modTimbradoMexico_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
